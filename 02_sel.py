...
for brand in brands:
    ...
    url = f'http://auto.danawa.com/newcar/?Work=record&Tab=Top10&Month=2020-01-00&MonthTo=2020-12-00&Brand={brand}'
    # url = f'http://auto.danawa.com/newcar/?Work=record&Tab=Top10&Month=2021-01-00&MonthTo=2021-05-00&Brand={brand}'
    time.sleep(2)
    driver.get(url)
    with open(f'./crawl_result/{brand}_20.html', 'w+', encoding='utf-8') as f:
